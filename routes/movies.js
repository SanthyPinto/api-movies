...
const { createMovieHandler, getMoviesHandler, getNewestMoviesHandler, createViewedMovieByUserHandler, getViewedMoviesByUserHandler } = require('../controllers/moviesController');
